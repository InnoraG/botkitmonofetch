...
class SlackBotWorker extends botkit_1.BotWorker {
    ...
    startPrivateConversation(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const channel = yield this.api.conversations.open({ users: userId });
            if (channel.ok === true) {
                // now, switch contexts
    ...
    replyInteractive(src, resp) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!src.incoming_message.channelData.response_url) {
                ...
                const fetchResponse = yield (0, cross_fetch_1.default)(src.incoming_message.channelData.response_url, { method: 'POST', body: JSON.stringify(msg) });
    ...
    updateMessage(update) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.getConfig('adapter').updateActivity(this.getConfig('context'), update);
        });
    }
    /**
    ...
    deleteMessage(update) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.getConfig('adapter').deleteActivity(this.getConfig('context'), {
